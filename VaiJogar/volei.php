...
<body>
  ...
  <header class="header">
    <div class="header-logo">
      ...
      <div id="filtro-modalidade">
        ...
        <button class="filtro-btn" data-mod="basquetebol">
          <span data-i18n="basquetebol">Basquetebol</span>
        </button>
        <button class="filtro-btn active" data-mod="voleibol">
  ...
  <script>window._modalidadeInicial = "voleibol";</script>
